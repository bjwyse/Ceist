...
public class CeistAboutBox extends javax.swing.JDialog {

    public CeistAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(Ceist.CeistApp.class).getContext().getResourceMap(CeistAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(Ceist.CeistApp.class).getContext().getActionMap(CeistAboutBox.class, this);
